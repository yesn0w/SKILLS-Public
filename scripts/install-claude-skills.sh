...
usage() {
  cat <<'USAGE'
Usage: bash scripts/install-claude-skills.sh [--dry-run]

Symlink Claude skills from this repository into ${CLAUDE_SKILLS_DIR:-$HOME/.claude/skills}.
...
echo "Claude skills install complete. Restart Claude Code or open a new session if the skills are not rediscovered."
